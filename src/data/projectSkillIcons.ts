...
export const projectSkillMetaMap: Record<string, ProjectSkillMeta> = {
  ...
  "C#": { iconClass: "devicon-csharp-plain", link: "https://learn.microsoft.com/dotnet/csharp/" },
  "C++": { iconClass: "devicon-cplusplus-plain", link: "https://isocpp.org/" },
  "Dart": { iconClass: "devicon-dart-plain", link: "https://dart.dev/" },
  "Kotlin": { iconClass: "devicon-kotlin-plain", link: "https://kotlinlang.org/" },
  ...
  "PHP": { iconClass: "devicon-php-plain", link: "https://www.php.net/" },
  "Python": { iconClass: "devicon-python-plain", link: "https://www.python.org/" },
